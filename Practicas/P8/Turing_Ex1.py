...
if __name__ == "__main__":
    ...
    # all A's and accept
    m = TuringMachine("AB", [3])

    m.addTransition(0, 'A', 1, 'A', 'R')
    m.addTransition(0, 'B', 1, 'B', 'R')
    m.addTransition(1, 'A', 1, 'A', 'R')
    m.addTransition(1, 'B', 1, 'B', 'R')
    m.addTransition(1, 'A', 2, 'B', 'L')
    m.addTransition(1, 'B', 2, 'B', 'L')
    m.addTransition(2, 'A', 3, 'B', 'L')
    m.addTransition(2, 'B', 3, 'B', 'L')
    m.addTransition(3, 'A', 2, 'A', 'L')
    m.addTransition(1, 'A', 2, 'B', 'L')
    m.addTransition(1, 'A', 2, 'B', 'L')
    m.addTransition(1, 'A', 2, 'B', 'L')
